...
export default function EditSupplierForm({ open, onOpenChange, supplier }: EditSupplierFormProps) {
  ...
  // Cập nhật form khi supplier thay đổi
  useEffect(() => {
    form.reset({
      supplierCode: supplier.id,
      supplierName: supplier.name,
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    toast({
      ...
      description: `Nhà cung cấp ${values.supplierName} đã được cập nhật.`,
      duration: 3000,
    })
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>Cập nhật thông tin chi tiết của nhà cung cấp. Nhấn Lưu khi hoàn tất.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="NCC001" {...field} readOnly />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
